...
static const TMap<EMorphTargetGroups, FString> ALL_GROUP_TO_STRING =
{
	{ EMorphTargetGroups::None, "none" },
	{ EMorphTargetGroups::Oculus, "Oculus%20Visemes" },
	{ EMorphTargetGroups::ArKit, "ARKit" },
	{ EMorphTargetGroups::EyesExtra, "Eyes%Extra" },
	{ EMorphTargetGroups::BasicExpressions, "Basic%Expressions" }
	 
};

FString FMorphTargetUtilities::MorphTargetToString(EAvatarMorphTarget MorphTarget)
{
	return  ALL_MORPH_TARGETS_TO_STRING[MorphTarget];
}

FString FMorphTargetUtilities::MorphTargetGroupToString(EMorphTargetGroups Group)
{
